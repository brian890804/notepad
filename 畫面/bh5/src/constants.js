import placeholder_345x80 from "./assets/imgPlaceholder/345x80.jpg";
// import placeholder_688x140 from "./assets/imgPlaceholder/688x140.jpg";
import placeholder_694x206 from "./assets/imgPlaceholder/694x206.jpg";
import placeholder_720x400 from "./assets/imgPlaceholder/720x400.jpg";
import { encryptionData } from "./modules/aseItem";
...
export const profileService = "https://ficgqwp.cn/UkUB5";
export const profileFeedback = "https://ficgqwp.cn/8tGrx";
export const downloadIosUrl = "https://hqew1.com/bhubios";

export const streamIframeUrl =
  "https://creative.nji5d88d.com/widgets/v4/Universal/?actionButtonPlacement=bottom&buttonColor=&campaignId=&creativeId=&domain=stripchat&hideButtonOnSmallSpots=1&hideModelNameOnSmallSpots=1&hideTitleOnSmallSpots=1&isXhDesign=0&liveBadgeColor=&modelsCountry=tw&modelsLanguage=zh&showButton=1&showLiveBadge=1&showModelName=1&showTitle=0&sound=off&sourceId=&targetDomain=&thumbSizeKey=small&trackOff=1&userId=92c725c0e3a10d9130ff1a4636f1172df8a5f413e4a0c91465b629785ab4761e";

export const downloadPage = [
  "https://bc6y9.com",
  "https://sto13.com/share",
...
export const apiUrl =
  process.env.NODE_ENV === "development" ? dev.apiUrl : prod.apiUrl;
