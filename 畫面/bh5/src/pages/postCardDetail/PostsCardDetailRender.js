...
import sendArrowIcon from "../../assets/icons/send_arrow.svg";
...
import unlikeIcon from "../../assets/post/like_nor.png";
    ...
    <PostCardDetailElement>
      {isMobile ? (
        <TopBarContainer>
          <TopTitleBar
            not_clear_history
            title={intl.formatMessage({ id: "POST.DYNAMIC_NEWS" })}
            showBack={true}
            color="#000"
            back_color="#fff"
            show_back_color="#000"
      ...
      {!isMobile && (
        <div className="message">
          ...
          <div className="message_description">
            {intl.formatMessage({ id: "POST.CARD_DETAIL.SPEECH_PROMPT" })}
          </div>
        </div>
      )}
      <div className="comment">
        <div className="comment_title">
          <span className="comment_title_text">
            {intl.formatMessage({ id: "POST.ALL_COMMENTS" })}
          </span>
        </div>
                  ...
                  <div className="comment_list_item_comment_time">
                    <span className="comment_list_item_comment_time_text">
                      <img
                        ...
                        src={data.sex === 1 ? femaleIcon : maleIcon}
                        alt="sexicon"
                      />
                      {data.show_time}
                    </span>
                ...
                >
                  <div className="comment_list_item_like_icon">
                    <img
                      ...
                      src={parseInt(data.is_like) === 0 ? unlikeIcon : likeIcon}
                      alt="iconUnlike"
                    />
                  </div>
                  <div className="comment_list_item_like_total">
                    {data.total_like === 0
                      ? intl.formatMessage({ id: "POST.LIKE" })
                      : data.total_like}
                  </div>
                </div>
              </div>
