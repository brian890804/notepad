...
// import { adsKeys, colors, downloadPageUrl, streamIframeUrl } from "../../constants";
import { adsKeys, colors, streamIframeUrl } from "../../constants";

import ImageCarousel from "../component/ImageCarousel";
import useMediaSetting from "../../reackHook/useMediaSetting";
// import ImageComponent from "../component/ImageComponent";

// import girl404Img from "../../assets/system/404.png";

// import { CSSTransition } from "react-transition-group";

const HomeStreamsPage = ({ streamList, getStreamList }) => {
  ...
  return (
    <HomeStreamsPageElement>
      ...
      <div className="m-1 title">
        {intl.formatMessage({ id: "STREAM.TIP.START" })}
        <label className="title_focus">
          {intl.formatMessage({ id: "STREAM.TIP.THIRE_SOFT_NAME" })}
        </label>
        {intl.formatMessage({ id: "STREAM.TIP.END" })}
      </div>
