...
import fileIcon from "../../assets/profile/transfer_file.svg";
...
const ProfilePaymentWithDrawHistoryRender = ({ getTransferHistory }) => {
  const intl = useIntl();
          ...
          <div className="transfer_record_card" key={data.create_time}>
            <div className="transfer_record_card_row">
              <div className="transfer_record_card_row_l">
                <img src={fileIcon} alt="fileIcon" className="mr-2" />
                实际到帐
              </div>
