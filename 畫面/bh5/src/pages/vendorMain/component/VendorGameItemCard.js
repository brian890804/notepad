...
import { apiUrl, colors, pageUrlConstants } from "../../../constants";
    ...
    <VendorItemCardElement>
      ...
      >
        ...
        <div className="container_amount">
          {intl.formatMessage({ id: "VENDOR.ITEM.LABEL.UNIT.REMAIN_AMOUNT" })}{" "}
          ：{data.qty}
        </div>
      </LinkComponent>
    </VendorItemCardElement>
...
export const moneyAndGold = (money, yue, intl) => {
  if (yue && money) {
    ...
    return (
      <div className="price"> {intl.formatMessage({ id: "GLOBAL.FREE" })}</div>
    );
  }
};
