...
const ProfileBundleReward = (state) => {
  const intl = useIntl();
    ...
    axiosRequest
      ...
      .then((data) => {
        ...
        element.innerText = intl.formatMessage({
          id: "PROFILE.BUILD.EFFECT.SUCCESS",
        });
        element.style.backgroundColor = "#73df65";
      })
      .catch((err) => {
        element.innerText = intl.formatMessage({
          id: "PROFILE.BUILD.EFFECT.UNSUCCESS",
        });
  ...
  function exchangeMyAwardActual() {
    ...
    if (
      ...
      axiosRequest
        ...
        .then(() => {
          callToast(intl.formatMessage({ id: "TOAST.TIP.SUCCESS.REDEMPTION" }));
          setExchangeActualData({});
        });
    } else {
      callToast(intl.formatMessage({ id: "TOAST.TIP.FULL_INPUT" }));
    }
  }
        ...
        <div className="actual_window">
          <div className="actual_window_title">
            <p className="actual_window_title_text">
              {intl.formatMessage({ id: "PROFILE.BUILD.INPUT.ADDRESS" })}
            </p>
            <CloseComponent
              styleType={3}
              callback={() => {
          ...
          <div className="actual_window_container">
            ...
            <div className="actual_window_container_body">
              <h3 className="actual_window_container_body_title">
                {intl.formatMessage({ id: "PROFILE.BUILD.INPUT.RECEIVER" })}
              </h3>
              <div className="actual_window_container_body_name">
                <input
                  ...
                  placeholder={intl.formatMessage({
                    id: "PROFILE.BUILD.PLACEHOLDER.RECEIVER.NAME",
                  })}
              ...
              <div className="actual_window_container_body_phone">
                <input
                  ...
                  type="number"
                  placeholder={intl.formatMessage({
                    id: "PROFILE.BUILD.PLACEHOLDER.PHONE",
                  })}
              ...
              <div className="actual_window_container_body_zip">
                <input
                  ...
                  type="number"
                  placeholder={intl.formatMessage({
                    id: "PROFILE.BUILD.PLACEHOLDER.POSTAL_CODE",
                  })}
              ...
              <div className="actual_window_container_body_addess">
                <input
                  ...
                  type="text"
                  placeholder={intl.formatMessage({
                    id: "PROFILE.BUILD.PLACEHOLDER.COMPLETE_ADDRESS",
                  })}
            ...
            >
              <span className="actual_window_container_footer_text">
                {intl.formatMessage({ id: "PROFILE.BUILD.LABEL.CONFIRM_SENT" })}
              </span>
            </div>
          </div>
        </div>
