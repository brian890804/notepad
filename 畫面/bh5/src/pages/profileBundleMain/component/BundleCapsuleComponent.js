  ...
  function exchangeMyAwardButton(event) {
    ...
    if (type === "virtual") {
      ...
      if (exchange_code) {
        ...
        element.innerText = intl.formatMessage({
          id: "PROFILE.BUILD.REDEMPTION.FAST_GO",
        });
          ...
          <div className="container_body">
            ...
            <div className="container_body_exchange">
              <p className="container_body_exchange_text">
                ...
                >
                  {is_receive
                    ? intl.formatMessage({
                        id: "PROFILE.BUILD.REDEMPTION.REDEMPTIONED",
                      })
                    : exchange_code
                    ? intl.formatMessage({
                        id: "PROFILE.BUILD.ACTION.CLICK.COPY",
                      })
                    : intl.formatMessage({
                        id: "PROFILE.BUILD.ACTION.CLICK.REDEMPTION",
                      })}
                </span>
              </p>
            </div>
            <div className="container_body_time">
              <p className="container_body_time_text">
                {intl.formatMessage({ id: "PROFILE.BUILD.VALIDITY.PERIOD" })}
