...
import bipinkIcon from "../../assets/profile/payment_bipink.svg";
import vipIcon from "../../assets/profile/payment_vip.svg.svg";
import rmbwhtieIcon from "../../assets/profile/payment_rmbwhtie.svg";

import transferCoin from "../../assets/profile/transfer_bicoin.svg";
import transferWithDraw from "../../assets/profile/transfer_withdraw.svg";
import documentIcon from "../../assets/icons/document.svg";
import { useLang } from "../../i18n/Metronici18n";
import useMediaSetting from "../../reackHook/useMediaSetting";
import ProfileTransferCoinPage from "../profileTransferCoin/ProfileTransferCoinHandle";
import CloseIcon from "@mui/icons-material/Close";
const { profile } = pageUrlConstants;

const ProfilePayment = ({ user, goHistory }) => {
  const intl = useIntl();
  const lang = useLang();
  ...
  const [infoData, setInfoData] = useState(() => [
    {
      icon: goldbagIcon,
      data: user.sign,
      text: intl.formatMessage({ id: "PROFILE.PAYMENT.OWN_GOLD" }),
    },
    {
      icon: moneyBagIcon,
      data: user.money,
      text: intl.formatMessage({ id: "PROFILE.PAYMENT" }),
    },
  ]);
  const [listData] = useState(() => [
    {
      ...
      text: intl.formatMessage({ id: "PROFILE.PAYMENT.CHARGE.HISTORY_CLEAR" }),
    },
  ]);
  ...
  return (
    <ProfilePaymentElement>
      <TopBarContainer show_shadow={false}>
        <TopTitleBar
          title={intl.formatMessage({ id: "GLOBAL.ACTION.CHARGE_1" })}
          showBack={true}
        ...
        <div className="info_container_content">
          <div className="info_container_content_title">
            <p className="info_container_content_title_text">
              {intl.formatMessage({ id: "PROFILE.PAYMENT.OWN_ACCOUNT" })}
            </p>
          </div>
          ...
          <div className="info_container_content_description">
            <p className="info_container_content_description_text">
              {intl.formatMessage({ id: "PROFILE.PAYMENT.DESCRIPTION" })}
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="payment_container_buttonbox">
          <LinkComponent
            ...
            routes={{
              linkurl:
                ...
                `?uid=${user.id}&ctype=2&content-language=${lang}`,
            }}
          >
            <p className="payment_container_buttonbox_button_content">
              <img
                ...
                src={bipinkIcon}
                alt={intl.formatMessage({ id: "GLOBAL.GOLD_MONEY" })}
              />
              <span className="payment_container_buttonbox_button_content_span">
                {intl.formatMessage({ id: "PROFILE.PAYMENT.CHARGE.GOLD" })}
              </span>
            </p>
          </LinkComponent>
          ...
          >
            <p className="payment_container_buttonbox_button_content">
              ...
              <span className="payment_container_buttonbox_button_content_span">
                {intl.formatMessage({
                  id: "PROFILE.PAYMENT.TRANSFER.DIRECT_PURCHASE",
                })}
              </span>
            </p>
          </LinkComponent>
          ...
          >
            <p className="payment_container_buttonbox_button_content">
              <img
                className="payment_container_buttonbox_button_content_img"
                src={rmbwhtieIcon}
                alt={intl.formatMessage({ id: "GLOBAL.MONEY" })}
              />
              <span className="payment_container_buttonbox_button_content_span">
                {intl.formatMessage({ id: "PROFILE.PAYMENT.CHARGE.DRILL" })}
              </span>
            </p>
          </LinkComponent>
        </div>
            ...
            <div className="list_container_card_body">
              <div className="list_container_card_body_item">
                ...
                <div className="list_container_card_body_item_body">
                  <p className="list_container_card_body_item_body_title fw-m ">
                    {intl.formatMessage({
                      id: "PROFILE.PAYMENT.TRANSFER.GOLD",
                    })}
                  </p>
                </div>
              </div>
              <div className="list_container_card_body_item_body_description ml-5">
                <p className="list_container_card_body_item_body_text">
                  {intl.formatMessage({ id: "PROFILE.PAYMENT.TRANSFER.GOLD" })}
                </p>
              </div>
            </div>
            <div className="list_container_card_footer">
        ...
        >
          <div className="list_container_card_body">
            ...
            <div className="list_container_card_body_item_body_description ml-5">
              <p className="list_container_card_body_item_body_text">
                {intl.formatMessage({
                  id: "PROFILE.PAYMENT.TRANSFER.WITH_DRAW_CONTENT",
                })}
              </p>
            </div>
          </div>
