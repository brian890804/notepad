...
import arrowDarkImg from "../../../assets/home/arrow_dark.svg";
import avatarPlaceholder from "../../../assets/imgPlaceholder/avatar.png";
import loadingImg from "../../../assets/home/loading.jpg";
    ...
    <SlideCarouselElement>
      ...
      <span className="home_Main_container_ranking_top g-flex-space-between  w-100 align-items-center px-3 py-1 ">
        <p className="home_Main_container_ranking_top_title fw-m">
          {intl.formatMessage({ id: "POST.RECOMMEND_ORIGINAL" })}
        </p>
        {!isMobile && (
                ...
                return (
                  <p className="original_carousel_item" key={index}>
                    <div
                      ...
                      style={{
                        backgroundImage: `url(${
                          thumb?.includes("video") ? loadingImg : thumb
                        })`,
                      }}
                    >
                      <div
                      ...
                      >
                        ...
                        >
                          <WavaButton
                            className={`original_carousel_card_img_follow_tip ${
                              is_follow && "followed"
                            }`}
                          >
                            {is_follow ? "已关注" : "关注"}
                      ...
                      >
                        <WavaButton
                          className={`original_carousel_card_subscribe ${
