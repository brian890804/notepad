...
import { dismissPreventPageScroll, preventPageScroll } from "../../reducers/actions/utilities";

const ListSideBar = ({ is_in, nowIndex, totalIndex, checkLock, clickClose, clickCallback }) => {
...
export const ListSideBarElement = styled.div`/*  */
position: fixed;
top: 0;
right: 0;
bottom: 0;
