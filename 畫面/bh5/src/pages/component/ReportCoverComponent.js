  ...
  return (
    ...
    >
      ...
      >
        ...
        {!toShowEnd ? (
          <>
            <h4 className="report_container_title ">{intl.formatMessage({ id: "REPORT.LABEL.REPORT.SUCCESS" })}</h4>
            <p className="report_container_text">{intl.formatMessage({ id: "REPORT.LABEL.REPORT.THANKS" })}</p>
            <p className="report_container_text">{intl.formatMessage({ id: "REPORT.LABEL.REPORT.FAST_PROCESS" })}</p>
            <div className="report_container_options_buttons">
              ...
              >
                {intl.formatMessage({ id: "GLOBAL.ACTION.CONFIRM" })}
              </button>
            </div>
          </>
        ) : (
          <>
            <h4 className="report_container_title mb-3">{intl.formatMessage({ id: "REPORT.LABEL.REPORT.PROBLEM" })}</h4>
            <div className="report_container_options">
              ...
              <label className="report_container_options_option pl-3">
                ...
                <input
                  ...
                  placeholder={intl.formatMessage({ id: "REPORT.LABEL.LABEL.PROBLEM.OTHER" })}
