...
import { ReactComponent as MentionAppCoverSvg }  from "../../assets/coverpage/mention_app_cover.svg";
import { downloadIosUrl, downloadPage, downloadPageUrl } from "../../constants";
import LinkComponent from "./LinkComponent";

function MentionAppCover ({closeMentionAppCover}) {

  useEffect(()=>{
    document.getElementById("clicklink").addEventListener('click', function(){
    ...
    QRCode.toDataURL(downloadPage[1], {
      ...
      .then((url) => {
        document.getElementById("animebliav-1qrcode").setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href', url);
      })
      .catch((err) => {
        console.error(err);
      });
      ...
      <div className="container">
        ...
        <div className="container_buttonbox">
          ...
          <div 
            ...
            className="container_buttonbox_button"
          >
            <span className="container_buttonbox_button_hightlight">我已截图</span>，
            来去看片
          </div>
        </div>
      </div>
