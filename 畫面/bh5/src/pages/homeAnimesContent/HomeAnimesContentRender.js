...
import ReactPlayerComponent from "../component/ReactPlayerComponent";
import ImageCarousel from "../component/ImageCarousel";
import { adsKeys, colors, padding } from "../../constants";
    ...
    <HomeAnimesContentElement>
      ...
      <div className="header">
        <ReactPlayerComponent
          ...
          animeNextRecommend={animeNextRecommend}
        />
      </div>
      <div className="pick">
        <div className="pick_header">
          ...
          >
            <span className="pick_header_more_text">
