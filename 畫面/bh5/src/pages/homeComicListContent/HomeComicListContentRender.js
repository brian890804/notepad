...
import InlineShareButton from "../component/InlineShareButton";
...
const HomeComicListContent = ({
  ...
  x.current++;
  useEffect(() => {
    if (comicId && !comicData.id) getComicContent(comicId);
    ...
    (page) =>
      comicData.buy_episode
        ? user.time === "-1" || Date.now() < user.time * 1000
          ? false
          : user.day_usedviewcount < user.day_maxviewcount
          ? false
    ...
    <HomeComicListContentElement>
      ...
      <div className="body">
        ...
        <div className="body_header mt-3">
          ...
          >
            <span className="body_header_more_text">
      ...
      <div className="recommend">
        <div className="recommend_title">
          {intl.formatMessage({ id: "GLOBAL.YOU_ALSO_LIKE" })}
        </div>
          ...
          >
            ...
            >
              <p className="footer_content_btn_wava_text">
                {intl.formatMessage({ id: "GLOBAL.START_READ" })}
                {nowPage}
                {intl.formatMessage({ id: "GLOBAL.WORD" })}
              </p>
            </WavaButton>
...
export const HomeComicListContentElement = styled.div`
  /*  */
