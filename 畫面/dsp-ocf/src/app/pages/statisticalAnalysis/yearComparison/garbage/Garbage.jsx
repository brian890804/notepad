...
const Garbage = ({ form, chartData }) => {
	...
	return (
		<section>
			<article className="garbage">
				<section className="garbage__term">
					{/* 規範 基準 GWP */}
				...
				<DSPEmptyHelper data={overView || {}} loading={loading} className="garbage__content">
					<div className={classNames('garbage__chart__groups', 'garbage__chart__pie', 'animation--fade-in')}>
						<div className="garbage__chart__groups__title">年度總類別比較</div>
					...
					{list?.map(item => {
						...
						return (
							<div className={classNames('garbage__chart__groups', 'animation--fade-in')} key={totalOverview.title}>
								<StackedChart
									showLegend
									chartType="stack"
									outFrame={false}
								...
								/>
								<Collapse
									className={'garbage__chart__groups__collapse'}
