...
const Electricity = ({ form, chartData }) => {
	...
	return (
		<article className="electricity">
			<section className="electricity__term">
			...
			<DSPEmptyHelper data={list || {}} loading={loading} className="electricity__content">
				<YearComparisonPieChart
					className={classNames('animation--fade-in', 'electricity__pie')}
					title={'年度比較圓餅圖'}
